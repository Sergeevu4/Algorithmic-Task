...
(function() {
  ...
  console.log({}.toSting.call(isArray));
...
(function() {
  /*
    ...
    * O(n!), факториал от числа n (поиск всех перестановок, пример — задачи коммивояжера) — 10 000 000 000 000 000 000 000 000… и еще очень много нулей.
