...
* 11) Вывести односвязный СПИСОК
* 12) Выборка по комментариям пользователей
*/
...
(function() {
  ...
  */
  ...
  // ! 11
  (function() {
    console.log('%c 11) ВЫВЕСТИ ОДНОСВЯЗНЫЙ СПИСОК', consoleLogStyles);
  ...
  // ! 12
  (function() {
    console.log('%c 12) ВЫБОРКА ПО КОММЕНТАРИЯМ ПОЛЬЗОВАТЕЛЕЙ', consoleLogStyles);
