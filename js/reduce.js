...
* 21)Вернуть индексы двух чисел, чтобы они в сумме равнялись target
* 22)Создание Маски номера телефона из массива чисел
*/
...
(function () {
  ...
  */
  ...
  (function () {
    console.log('%c 22) Создание Маски номера телефона из массива чисел', consoleLogStyles);
    // https://www.codewars.com/kata/525f50e3b73515a6db000b83/train/javascript

    /*
      Создание Маски номера телефона из массива чисел
  ...
  */
    ...
    function createPhoneNumber(numbers, placeholder = '(000) 000-0000') {
      let indexNumbers = 0;

      return Array.from(placeholder).reduce(
        (res, chart) => (chart === '0' ? (res += numbers[indexNumbers++]) : (res += chart)),
        ''
      );
    }

    // createPhoneNumber([1, 2, 3, 4, 5, 6, 7, 8, 9, 0]); //=> (123) 456-7890
    // createPhoneNumber([1, 2, 3, 4, 5, 6, 7, 8, 9, 0], '(000) 00-00-000'); //=> (123) 45-67-890
  })();
})();
