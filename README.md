  ...
  ## task.js
    ...
    5. Перенос груза с автомобиля на автомобиль
    6. CODEWARS: Вернуть первую самую длинную строку
    7. Отсортировать книги по имени автора #Point-free
    8. Яндекс: Бинарном векторе (Массиве. самую длинную последовательность единиц
    9. Яндекс: в массиве найти сумму чисел равную k
    10. Яндекс: Объединение отсортированных массивов
    11. Яндекс: Сжатие строки
    12. Яндекс: Сжатие целочисленного массива
    13. Яндекс: Отсортировать массив только по нечетным значениям
    14. Яндекс: Функция рандомного hex цвета + из rgb в hex
    15. Яндекс: Генерация рандомного баннера
